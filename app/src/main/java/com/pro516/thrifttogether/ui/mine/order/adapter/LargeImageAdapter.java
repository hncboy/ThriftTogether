package com.pro516.thrifttogether.ui.mine.order.adapter;
...
public class LargeImageAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup viewGroup, int position) {
        ...
        final PhotoDraweeView photoDraweeView = inflater.inflate(R.layout.include_large_image, null).findViewById(R.id.sdv_larget_image);
