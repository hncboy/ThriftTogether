...
public class GoodsFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void initRecyclerView(List<CollectedProductVO> mData) {
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                List<CollectedProductVO> data = adapter.getData();
                CollectedProductVO item = data.get(position);
        ...
        mAdapter.setOnItemLongClickListener(new BaseQuickAdapter.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                Toast.makeText(getActivity(), "productID" + mData.get(position).getId(), Toast.LENGTH_SHORT).show();
                deleteConfirmationDialog(position, Url.COLLECTION+userID+"/product/"+mData.get(position).getId(),getActivity());
                return false;
            }
        });
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ERROR:
                    ...
                    break;
                case LOAD_ALL:
                    initRecyclerView((List<CollectedProductVO>) msg.obj);
    ...
    private void loadData() {
        new Thread() {
            ...
            public void run() {
                try {
                    String json = HttpUtils.getStringFromServer(Url.COLLECTION+userID+"/product");
                    List<CollectedProductVO> mData = JsonParser.collectionProductList(json);
