...
import com.pro516.thrifttogether.ui.mine.order.adapter.LargeImageAdapter;
...
public class CommentLargeImageActivity extends BaseActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    public void initView() {
        vp_large_image = findViewById(R.id.vp_large_image);
        ...
        if (bundle != null) {
            currentIndex = bundle.getInt(OrderCommentActivity.KEY_CURRENT_INDEX);
            imgUrls = bundle.getStringArrayList(OrderCommentActivity.KEY_IMAGE_LIST);
    ...
    public void onBackPressed() {
        ...
        intent.putStringArrayListExtra(OrderCommentActivity.KEY_IMAGE_LIST, (ArrayList<String>) adapter.getData());
